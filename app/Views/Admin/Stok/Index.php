        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    ...
                    <?php endif; ?>
                    <a href="<?= base_url()  ?>/admin/stok/add" class="btn btn-primary btn-sm float-end">Tambah</a>
                </div>
                <div class="card-body">
                            ...
                            foreach ($stok as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <a href="<?= base_url("admin/stok/delete/" . $value->id) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ?')">
                                            ...
                                            <div class="col">
                                                <a href="<?= base_url("admin/stok/edit/" . $value->id) ?>">
